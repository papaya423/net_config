...
class MainWindow(QMainWindow):  
    ...
    def show_current_file_path(self):
        self.run_directory = QCoreApplication.applicationDirPath()
        print("程序运行目录:", self.run_directory)
        # 获取当前正在运行的 .py 文件的路径
        self.current_file_path = os.path.abspath(__file__)
        n= self.current_file_path.rfind("\\")
        print(self.current_file_path)
        self.current_file_path=self.current_file_path[0:n+1]
